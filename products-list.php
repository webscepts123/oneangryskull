...
?>
  ...
  <section class="main-header" style="background-image:url(assets/images/gallery-2.jpg)">
            <header>
                <div class="container">
                    <h1 class="h2 title">Shop list</h1>
                    <ol class="breadcrumb breadcrumb-inverted">
                        <li><a href="index.html"><span class="icon icon-home"></span></a></li>
                        <li><a href="category.html">Product Category</a></li>
                        <li><a class="active" href="products-list.html">Product Sub-category</a></li>
                    </ol>
                </div>
            </header>
        </section>
                        ...
                        <div class="col-md-12">
                            <article>
                                ...
                                <div class="figure-list">
                                    ...
                                    <div class="text">
                                        <h2 class="title h4"><a href="product.html">Iron set</a></h2>
                                        <sub>$ 3999,-</sub>
                                        <sup>$ 3499,-</sup>
                                        <span class="description clearfix">Gubergren amet dolor ea diam takimata consetetur facilisis blandit et aliquyam lorem ea duo labore diam sit et consetetur nulla</span>
                                    </div>
                        ...
                        <div class="col-md-12">
                            <article>
                                ...
                                <div class="figure-list">
                                    ...
                                    <div class="text">
                                        <h2 class="title h4"><a href="product.html">Projector 4k</a></h2>
                                        <sup>$ 2999,-</sup>
                                        <span class="description clearfix">Gubergren amet dolor ea diam takimata consetetur facilisis blandit et aliquyam lorem ea duo labore diam sit et consetetur nulla</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12">
                            <article>
                                ...
                                <div class="figure-list">
                                    ...
                                    <div class="text">
                                        <h2 class="title h4"><a href="product.html">Headphones Wireless</a></h2>
                                        <sup>$ 299,-</sup>
                                        <span class="description clearfix">Gubergren amet dolor ea diam takimata consetetur facilisis blandit et aliquyam lorem ea duo labore diam sit et consetetur nulla</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12">
                            <article>
                                ...
                                <div class="figure-list">
                                    ...
                                    <div class="text">
                                        <h2 class="title h4"><a href="product.html">Vacuum cleaner</a></h2>
                                        <sub>$ 1999,-</sub>
                                        <sup>$ 1499,-</sup>
                                        <span class="description clearfix">Gubergren amet dolor ea diam takimata consetetur facilisis blandit et aliquyam lorem ea duo labore diam sit et consetetur nulla</span>
                                    </div>
                        ...
                        <div class="col-md-12">
                            <article>
                                ...
                                <div class="figure-list">
                                    ...
                                    <div class="text">
                                        <h2 class="title h4"><a href="product.html">E-shaver 500</a></h2>
                                        <sup>$ 896,-</sup>
                                        <span class="description clearfix">Gubergren amet dolor ea diam takimata consetetur facilisis blandit et aliquyam lorem ea duo labore diam sit et consetetur nulla</span>
                                    </div>
                                </div>
