                    ...
                    <div class="row product-flex">
                        ...
                        <div class="col-md-4 col-sm-12 product-flex-info">
                            <div class="clearfix">
                                ...
                                <button type="submit" class="btn btn-buy" data-text="Buy"></button>
                                    ...
                                    <div class="info-box">
                                        <span><strong>Select Qty</strong></span>
                                        <div class="product-colors clearfix">
                        ...
                        <div class="col-md-8 col-sm-12 product-flex-gallery">
                            ...
                            <div class="owl-product-gallery open-popup-gallery">
                                <a href="assets/images/product-10.png"><img src=<?php echo get_theme_file_uri( 'assets/images/product-4.png' );  ?> alt="" height="500" /></a>
                                <a href="assets/images/product-10a.png"><img src=<?php echo get_theme_file_uri( 'assets/images/product-4.png' );  ?> alt="" height="500" /></a>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="brands">
                                <div class="box">
                                    <div class="image">
                                        <img src=<?php echo get_theme_file_uri( 'assets/images/logo-2.png' );  ?> alt="Alternate Text" />
                                    </div>
                                    <div class="name">
                                        <p>Brand name</p>
                                                    ...
                                                    <div class="comment-wrapper">
                                                        ...
                                                        <div class="comment-block">
                                                            <div class="comment-user">
                                                                <div>
                                                                    <img src=<?php echo get_theme_file_uri( 'assets/images/user-2.jpg' );  ?> alt="Alternate Text" width="70" />
                                                                </div>
                                                                <div>
                                                                    <h5>
                                                                        <span>John Doe</span>
